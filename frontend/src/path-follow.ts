...
function sample(t: number): SampleResult {
...
function initPathFollow(pathBg: HTMLElement, pathMarker: HTMLElement): void {
...
const pathBg = document.querySelector<HTMLElement>(".path-bg");
const pathMarker = document.querySelector<HTMLElement>(".path-marker");
